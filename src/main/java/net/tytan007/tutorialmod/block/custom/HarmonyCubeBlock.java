package net.tytan007.tutorialmod.block.custom;
...
public class HarmonyCubeBlock extends Block {
    public HarmonyCubeBlock(Properties properties) {
        super(properties);
    }
    ...
    public void stepOn(Level level, BlockPos pos, BlockState state, Entity entity) {
        if(entity instanceof ItemEntity itemEntity) {
            if(itemEntity.getItem().getItem() == ModItems.DORO.get()) {
