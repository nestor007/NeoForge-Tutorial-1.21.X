package net.tytan007.tutorialmod.block;
...
public class ModBlocks {
    ...
    public static final DeferredBlock<Block> DORO_HD_BLOCK = registerBlock("doro_hd_block",
            () -> new Block(BlockBehaviour.Properties.of()
                    .strength(4f).requiresCorrectToolForDrops().sound(SoundType.AMETHYST)));

    public static final DeferredBlock<Block> DORO_BLOCK = registerBlock("doro_block",
